...
var optionsPie = {
    labelInterpolationFnc: function(value) {
      return Math.round(value / simplePieChartData.series.reduce(sum) * 100) + '%';
    }
}
              ...
              <div className="col-md-4 col-sm-12">
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    >
                    <ChartistGraph data={simplePieChartData}  options={optionsPie} type={"Pie"} />
                    </div>
                ...
                <div className="card ">
                  ...
                  <div className="card-body ">
                    <div id="chartHours" className="ct-chart">
                      <ChartistGraph data={simpleLineChartData} type={"Line"} responsiveOptions={responsiveOptions}/>
                    </div>
                  </div>
                            ...
                            <div className="card ">
                                ...
                                <div className="card-body ">
                                    <div id="chartActivity" className="ct-chart">
                                      <ChartistGraph className="ct-chart" id="chartActivity"  data={simpleBarChartData} options={optionsBar} type={"Bar"} responsiveOptions={responsiveOptions}/>
                                    </div>
                                </div>
                                <div className="card-footer ">
                                    <div className="legend">
